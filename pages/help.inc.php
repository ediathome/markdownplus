...
if (!class_exists('Parsedown')) {
	require($REX['INCLUDE_PATH'] . '/addons/markdownplus/classes/class.parsedown.inc.php');
}

// chapters
$chapterpages = array (
	'' => array($I18N->msg('markdown_help_chapter_readme'), 'pages/help/readme.inc.php'),
	'changelog' => array($I18N->msg('markdown_help_chapter_changelog'), 'pages/help/changelog.inc.php'),
	'license' => array($I18N->msg('markdown_help_chapter_license'), 'pages/help/license.inc.php'),
);
